Shader ".ShaderExample/PerlinVertexExtrude"
{
    Properties {
    ...
    SubShader 
    {
	    ...
	    void surf (Input IN, inout SurfaceOutput o) {
			...
			//float timer = cos( _Time[1] * 5);
			float timer = sin( _Time ) ;
	    	float4 res = float4(timer , _G, _B , _A);
