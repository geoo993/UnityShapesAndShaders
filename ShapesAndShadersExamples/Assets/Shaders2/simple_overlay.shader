Shader "Oberonscourt/Simple_overlay"
{
	Properties 
	{
...
Fog{
		...
		CGPROGRAM
#pragma surface surf BlinnPhongEditor  exclude_path:prepass noambient nolightmap noforwardadd approxview halfasview alpha decal:add vertex:vert
#pragma target 2.0
